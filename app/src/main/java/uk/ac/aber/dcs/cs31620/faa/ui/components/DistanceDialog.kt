...
/**
 * Displays the distance dialog where adopters can indicate
 * how far they are willing to travel.
 * @param distance The current distance they are willing to travel
 * @param dialogIsOpen Indicates whether the dialog is currently displayed
 * @param dialogOpen A lambda called when dialog is closed
 * @param changeDistance A lambda called when the dialog changes the distance
 */
@Composable
fun DistanceDialog(
    distance: Int,
